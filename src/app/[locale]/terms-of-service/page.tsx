...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Anime Story 2 Wiki",
    description: "Read the Terms of Service for Anime Story 2 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Anime Story 2 Wiki",
      description: "Terms and conditions for using Anime Story 2 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Anime Story 2 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Anime Story 2 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Anime Story 2 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Anime Story 2 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox experience "Anime Story 2". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Anime Story 2 Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official Anime Story Lab. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Anime Story 2 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the Anime Story Lab. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Roblox experience availability and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox, community pages, social media platforms,
            ...
            <p>
              ...
              you and Anime Story 2 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@anime-story-2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@anime-story-2.wiki</a>
            </p>
            <p>
