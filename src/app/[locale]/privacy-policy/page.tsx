...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Anime Story 2 Wiki',
    description: 'Anime Story 2 Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Anime Story 2 Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Roblox, community pages, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Anime Story 2 Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation or the Anime Story Lab. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@anime-story-2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@anime-story-2.wiki</a>
            </p>
            <p>
