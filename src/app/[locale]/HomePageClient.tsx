    ...
    "@graph": [
      {
        ...
        description:
          "Complete Anime Story 2 Wiki covering codes, units, traits, relics, worlds, and progression tips for Roblox players.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Anime Story 2 - Roblox Anime Adventure RPG",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Anime Story 2 Wiki",
        alternateName: "Anime Story 2",
        url: siteUrl,
        description:
          "Complete Anime Story 2 Wiki resource hub for crafting, biomes, creatures, items, achievements, and survival guides",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Anime Story 2 Wiki - Roblox Anime Adventure RPG",
        },
        sameAs: [
      ...
      },
      {
        ...
        genre: ["Anime", "Adventure", "RPG", "Action"],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 1,
        },
        offers: {
          ...
          url: "https://www.roblox.com/games/116766451305209/Anime-Story-2",
        },
      },
      {
        "@type": "VideoObject",
        name: "Anime Story 2 Release & Codes",
        description:
          "Anime Story 2 gameplay and active codes overview video for new and returning Roblox players.",
        uploadDate: "2026-03-12",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/QzjTUZUQeAE",
        url: "https://www.youtube.com/watch?v=QzjTUZUQeAE",
      },
    ],
  };
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-4xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="QzjTUZUQeAE"
              title="Anime Story 2 Release & Codes"
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-[hsl(var(--nav-theme))]/10 border-[hsl(var(--nav-theme)/0.3)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
              ...
              (p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-[hsl(var(--nav-theme))]/10 border-[hsl(var(--nav-theme)/0.3)] text-[hsl(var(--nav-theme-light))]" : p.priority === "Very High" ? "bg-orange-500/10 border-orange-500/30 text-orange-400" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {p.priority}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://www.roblox.com/communities/35906875/Anime-Story-Lab"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.youtube.com/watch?v=QzjTUZUQeAE"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
