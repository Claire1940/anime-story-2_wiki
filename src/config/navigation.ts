...
export const NAVIGATION_CONFIG: NavigationItem[] = [
	...
	{ key: 'modes', path: '/modes', icon: Swords, isContentType: true },
	{ key: 'summons', path: '/summons', icon: Sparkles, isContentType: true },
	{ key: 'tierList', path: '/tier-list', icon: Trophy, isContentType: true },
	{ key: 'traits', path: '/traits', icon: Users, isContentType: true },
]
